...
@section('main-content')
    <div class="card">
        <div class="card-header d-flex justify-content-between bg-dark">
            <div>
                <h5 class="card-title text-white">Add Notification</h5>
            </div>
            <div>
            ...
            <form action="{{ route('notices.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <small class="text-muted">Leave empty to send it now.</small>
                    </div>

                    <div class="mb-3 col-md-12">
                        <label class="form-label">Short Description</label>
                        <input type="text" name="short_description" class="form-control"
                               placeholder="the one line the app shows in the list"
                    ...
                    <div class="mb-3 col-md-12 px-5">
                        ...
                        <textarea name="description" id="summernote" class="form-control"
                                  placeholder="notification detail">{{ old('description') }}</textarea>
                    </div>
                </div>
